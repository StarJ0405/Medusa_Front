                ...
                <VerticalFlex backgroundColor={"white"} gap={50} padding={"20px"}>
                            ...
                            isMobile
                                            ...
                                            <FlexChild>
                                                <VerticalFlex>
                                                    <FlexChild justifyContent={"center"}>
                                                        <P weight={"bold"} size={"16pt"}>교환/환불 접수</P>
                                                    </FlexChild>
                                                    <FlexChild justifyContent={"center"}>
                                    ...
                                    <FlexChild>
                                        <HorizontalFlex>
                                            ...
                                            <FlexChild>
                                                <VerticalFlex>
                                                    <FlexChild justifyContent={"center"}>
                                                        <P weight={"bold"} size={"16pt"}>상품 재포장</P>
                                                    </FlexChild>
                                                    <FlexChild justifyContent={"center"}>
                                                        <Center>
                                    ...
                                    <FlexChild>
                                        <HorizontalFlex>
                                            ...
                                            <FlexChild>
                                                <VerticalFlex>
                                                    <FlexChild justifyContent={"center"}>
                                                        <P weight={"bold"} size={"16pt"}>상품 수거</P>
                                                    </FlexChild>
                                                    <FlexChild justifyContent={"center"}>
                                                        <Center>
                                    ...
                                    <FlexChild>
                                        <HorizontalFlex>
                                            ...
                                            <FlexChild>
                                                <VerticalFlex>
                                                    <FlexChild justifyContent={"center"}>
                                                        <P weight={"bold"} size={"16pt"}>상품 확인</P>
                                                    </FlexChild>
                                                    <FlexChild justifyContent={"center"}>
                                                        <Center>
                                    ...
                                    <FlexChild>
                                        <HorizontalFlex>
                                            ...
                                            <FlexChild>
                                                <VerticalFlex>
                                                    <FlexChild justifyContent={"center"}>
                                                        <P weight={"bold"} size={"16pt"}>판매자 확인</P>
                                                    </FlexChild>
                                                    <FlexChild justifyContent={"center"}>
                                                        <Center>
                                ...
                                <VerticalFlex>
                                    ...
                                    <FlexChild>
                                        <HorizontalFlex>
                                            <FlexChild justifyContent={"center"}>
                                                <P weight={"bold"} size={"18pt"}>교환/환불 접수</P>
                                            </FlexChild>
                                            <FlexChild justifyContent={"center"}>
                                                <P weight={"bold"} size={"18pt"}>상품 재포장</P>
                                            </FlexChild>
                                            <FlexChild justifyContent={"center"}>
                                                <P weight={"bold"} size={"18pt"}>상품 수거</P>
                                            </FlexChild>
                                            <FlexChild justifyContent={"center"}>
                                                <P weight={"bold"} size={"18pt"}>상품 확인</P>
                                            </FlexChild>
                                            <FlexChild justifyContent={"center"}>
                                                <P weight={"bold"} size={"18pt"}>판매자 확인</P>
                                            </FlexChild>
                                        </HorizontalFlex>
                                    </FlexChild>
                                    <FlexChild>
                    ...
                    <FlexChild>
                        <Center width={"100%"} textAlign={"left"}>
                            <P weight={"bold"} size={"18pt"}>교환/환불 FAQ</P>
                        </Center>
                    </FlexChild>
                                ...
                                <HorizontalFlex>
                                    ...
                                    <FlexChild padding={"0 0 0 20px"}>
                                        <VerticalFlex>
                                            ...
                                            <FlexChild>
                                                <Center width={"100%"} textAlign={"left"}>
                                                    <P size={"10pt"}>단순변심(배송비 소비자 부담)은 상품 수령일로부터 7일 이내 신청가능합니다.</P>
                                                </Center>
                                            </FlexChild>
                                        </VerticalFlex>
                                    </FlexChild>
                                ...
                                <HorizontalFlex>
                                    ...
                                    <FlexChild padding={"0 0 0 20px"}>
                                        <VerticalFlex>
                                            <FlexChild>
                                                <Center width={"100%"} textAlign={"left"}>
                                                    <P color={"black"}>상품 수령일로부터 7일 이후에 상품의 문제를 발견한다면?</P>
                                                </Center>
                                            </FlexChild>
                                            <FlexChild>
                                                <Center width={"100%"} textAlign={"left"}>
                                ...
                                <HorizontalFlex>
                                    ...
                                    <FlexChild padding={"0 0 0 20px"}>
                                        <VerticalFlex>
                                            ...
                                            <FlexChild>
                                                <Center width={"100%"} textAlign={"left"}>
                                                    <P size={"10pt"}>마이페이지 교환/환불 신청에서 접수하시면, 입점사 확인 후 처리됩니다.</P>
                                                </Center>
                                            </FlexChild>
                                        </VerticalFlex>
                                    </FlexChild>
                                ...
                                <HorizontalFlex>
                                    ...
                                    <FlexChild padding={"0 0 0 20px"}>
                                        <VerticalFlex>
                                            ...
                                            <FlexChild>
                                                <Center width={"100%"} textAlign={"left"}>
                                                    <P size={"10pt"}>입점사에서 물건을 확인 후 처리되기 떄문에 시일이 소요될 수 있습니다.</P>
                                                </Center>
                                            </FlexChild>
                                        </VerticalFlex>
                                    </FlexChild>
                        ...
                        <VerticalFlex>
                            <FlexChild>
                                <HorizontalFlex>
                                    ...
                                    <FlexChild>
                                        <P weight={"bold"} size={"16pt"}>이런 경우, 교환/환불이 불가합니다.</P>
                                    </FlexChild>
                                </HorizontalFlex>
                            </FlexChild>
                            <FlexChild>
                                <Center width={"100%"} textAlign={"left"}>
                                    <P weight={"bold"} size={"10pt"}>1. 소비자의 책임이 있는 사유로 상품 등이 멸실/훼손된 경우(단, 상품 확인을 위한 포장 훼손 제외)</P>
                                    <P weight={"bold"} size={"10pt"}>2. 소비자의 사용/소비에 의해 상품 등의 가치가 현저히 감소한 경우</P>
                                    <P weight={"bold"} size={"10pt"}>3.시간의 결과에 의해 재판매가 곤란할 정도로 상품 등의 가치가 현저히 감소한 경우</P>
                                    <P weight={"bold"} size={"10pt"}>4. 복제가 가능한 상품 등의 포장을 훼손한 경우</P>
                                    <P weight={"bold"} size={"10pt"}>5. 판매/생산 방식의 특성상, 교환/반품시 판매자에게 회복할 수 없는 손해가 발생하는 경우</P>
