...
function AdminSideBar() {
  ...
  const { sidebarShow, sidebarUnfoldable } = useSelector((state) => ({
    sidebarShow: state.vendor.sidebarShow,
    sidebarUnfoldable: state.vendor.sidebarUnfoldable,
  }));
  ...
  useEffect(() => {
    ...
    return () => {
      sidebar.current.removeEventListener(
        "transitionend",
  ...
  return (
    <CSidebar
      ...
      visible={isMobile ? sidebarShow : true}
    >
