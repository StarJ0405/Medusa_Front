...
function ProductManagement() {
    ...
    useEffect(() => {
        if (mounted) {
            requester.getProductManagement((result) => {
                setData(result.data);
            })
        }
    }, [mounted])
                                    ...
                                    <div className={style.boxArea}>
                                        <VerticalFlex gap={5}>
                                            ...
                                            <FlexChild>
                                                <Center>
                                                    <Inline>
                                                        <P size={"14pt"} weight={"bold"} color={"#5471e6"}>{data.almostOutOfStock}</P>
                                                        <P> 건</P>
                                                    </Inline>
                                                </Center>
                                            </FlexChild>
                                    ...
                                    <div className={style.boxArea}>
                                        <VerticalFlex gap={5}>
                                            ...
                                            <FlexChild>
                                                <Center>
                                                    <Inline>
                                                        <P size={"14pt"} weight={"bold"} color={"#5471e6"}>{data.needToBeManaged}</P>
                                                        <P> 건</P>
                                                    </Inline>
                                                </Center>
                                            </FlexChild>
                                    ...
                                    <div className={style.boxArea}>
                                        <VerticalFlex gap={5}>
                                            ...
                                            <FlexChild>
                                                <Center>
                                                    <Inline>
                                                        <P size={"14pt"} weight={"bold"} color={"#5471e6"}>{data.hotProduct}</P>
                                                        <P> 건</P>
                                                    </Inline>
                                                </Center>
                                            </FlexChild>
