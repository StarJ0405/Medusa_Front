        ...
        const orderStatusData = [
          {
            ...
            value: "CancelRequest",
            value2: "Canceled",
            count: data.cancel?.[0] || 0,
            count2: data.cancel?.[1] || 0,
          },
          {
            text: t("Exchange"),
            value: "ExchangeRequest",
            value2: "ExchangeCompleted",
            count: data.exchange?.[0] || 0,
            count2: data.exchange?.[1] || 0,
          },
          {
            text: t("ReturnProduct"),
            value: "ReturnRequest",
            value2: "ReturnCompleted",
            count: data.return?.[0] || 0,
            count2: data.return?.[1] || 0,
          },
          {
            text: t("Refund"),
            value: "RefundRequest",
            value2: "RefundCompleted",
            count: data.refund?.[0] || 0,
            count2: data.refund?.[1] || 0,
          },
        ];
        ...
        const orderStatusData = [
          {
            ...
            value: "CancelRequest",
            value2: "Canceled",
            count: result.data.canceledRequest
              ? result.data.canceledRequest
              : 0,
          ...
          },
          {
            ...
            value: "ExchangeRequest",
            value2: "ExchangeCompleted",
            count: result.data.exchangeRequest
              ? result.data.exchangeRequest
              : 0,
            count2: result.data.exchangeCompleted
              ? result.data.exchangeCompleted
              : 0,
          },
          {
            text: t("ReturnProduct"),
            ...
            count2: result.data.returnCompleted
              ? result.data.returnCompleted
              : 0,
          },
          {
            text: t("Refund"),
            ...
            count2: result.data.refundCompleted
              ? result.data.refundCompleted
              : 0,
          },
        ];
        setExchangeAndRefund(orderStatusData);
                      ...
                      <HorizontalFlex gap={5}>
                        ...
                        <FlexChild>
                          <Inline>
                            <P
                              hover
                              onClick={() => onStatusClick(data.value2)}
                              cursor
                              weight={"bold"}
                              color={"var(--main-color)"}
                            >
