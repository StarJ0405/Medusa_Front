            ...
            <FlexChild padding={"10px 0 0 0"}>
              <HorizontalFlex>
                <FlexChild>
                  <p
                    onClick={on7dayClick}
                    className={clsx(style.selectButton, {
                ...
                <FlexChild>
                  <p
                    onClick={onSixMonthClick}
                    className={clsx(style.selectButton, {
                      [style.active]: active[4],
                    })}
                  >
                    {t("6month")}
                  </p>
                ...
                <FlexChild>
                  <p
                    onClick={onOneYearClick}
                    className={clsx(style.selectButton, {
                      [style.active]: active[5],
                    })}
                  >
                    {t("1year")}
                  </p>
