...
import style from "./PromotionDetailModal.module.css"
...
const PromotionDetailModal = NiceModal.create(
    (props, ref) => {
        const modal = useRef();
        const { t } = useTranslation();
        const [withHeader, withFooter] = [true, false];
        const [width, height] = [props.width || "60%", props.height || "50%"];
                                ...
                                <HorizontalFlex gap={20} flexStart>
                                    ...
                                    <FlexChild>
                                        <VerticalFlex flexStart>
                                            {
                                                data.promotionBrands.map((row, index) => {
